    ...
    <footer className="bg-gray-50 py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-bold mb-4 text-primary">LinkBeacon<span className="text-brand-lime">.</span></h3>
            <p className="text-gray-600">Your identity, simplified into a single beautiful link.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Examples</Link></li>
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">FAQ</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Templates</Link></li>
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Blog</Link></li>
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Tutorials</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#" className="text-gray-600 hover:text-primary transition-colors">Legal</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500 mb-4 md:mb-0">© {new Date().getFullYear()} LinkBeacon. All rights reserved.</p>
